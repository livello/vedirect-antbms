...
void print_value(){
    ...
    ESP_LOGI(ANT_TAG,"Estado de Carga = %d",chg_status);
    ESP_LOGI(ANT_TAG,"Estado de Descarga = %d",dischg_status);
    ESP_LOGI(ANT_TAG,"Estado de Balance = %d",balance_status);
    ESP_LOGI(ANT_TAG,"Tensión celda media = %0.3fV",cell_av/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda mínima = %0.3fV",cell_min/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda máxima = %0.3fV",cell_max/1000.0);
    ESP_LOGI(ANT_TAG,"Diferencia = %0.3fV",(cell_max-cell_min)/1000.0);
    ESP_LOGI(ANT_TAG,"Temperatura MOSFET = %d°C",t_fet);
    ESP_LOGI(ANT_TAG,"Temperatura Balanceador = %d°C",t_bal);
    ESP_LOGI(ANT_TAG,"Temperatura Sensor 1 = %d°C",t_1);
    ESP_LOGI(ANT_TAG,"Temperatura Sensor 2 = %d°C",t_2);
    ESP_LOGI(ANT_TAG,"Temperatura Sensor 3 = %d°C",t_3);
    ESP_LOGI(ANT_TAG,"Temperatura Sensor 4 = %d°C",t_4);
    ESP_LOGI(ANT_TAG,"Tensión celda 1 = %0.3fV",cell_1/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 3 = %0.3fV",cell_3/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 2 = %0.3fV",cell_2/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 4 = %0.3fV",cell_4/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 5 = %0.3fV",cell_5/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 6 = %0.3fV",cell_6/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 7 = %0.3fV",cell_7/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 8 = %0.3fV",cell_8/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 9 = %0.3fV",cell_9/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 10 = %0.3fV",cell_10/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 11 = %0.3fV",cell_11/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 12 = %0.3fV",cell_12/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 13 = %0.3fV",cell_13/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 14 = %0.3fV",cell_14/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 15 = %0.3fV",cell_15/1000.0);
    ESP_LOGI(ANT_TAG,"Tensión celda 16 = %0.3fV",cell_16/1000.0);
    ESP_LOGI(ANT_TAG,"Capacidad total = %0.1fAh",Ah_install/1000000.0);
    ESP_LOGI(ANT_TAG,"Capacidad restante = %0.1fAh",Ah_rest/1000000.0);
    ESP_LOGI(ANT_TAG,"Capacidad ciclo = %0.1fAh",Ah_Total/1000000.0);
}